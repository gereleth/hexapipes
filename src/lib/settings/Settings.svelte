...
<div class="container settings" class:hidden>
	...
	{#if !hidden}
		...
		<div class="controlMode">
			<h3>Zoom and pan</h3>
			<p>
				If you find current zoom and pan functions uncomfortable you can disable them. Puzzles will
				be shown fully zoomed out. You can rely on browser zoom to deal with small tiles.
			</p>
			<label>
